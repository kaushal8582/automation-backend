...
import {
  ...
  instagramExchange,
  listAccounts,
  listFacebookAccountsHandler,
  listInstagramAccountsHandler,
  reconnectAccount,
  removeAccount,
  testPublishInstagram,
} from '../controllers/social.controller.js';
import { requireAuth } from '../middlewares/auth.js';
import { validateBody } from '../middlewares/validate.js';
import {
  instagramOAuthExchangeSchema,
  instagramTestPublishSchema,
  manualSocialAccountSchema,
...
router.post(
  '/instagram/test-publish',
  validateBody(instagramTestPublishSchema),
  testPublishInstagram,
);
