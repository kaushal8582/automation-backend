...
import {
  ...
  getImportSources,
  importAccountMedia,
  importInstagramPublic,
  importUrl,
  previewInstagramPublic,
  previewUrl,
  retryFailedImport,
} from '../controllers/content-import.controller.js';
import { requireAuth } from '../middlewares/auth.js';
import { validateBody, validateQuery } from '../middlewares/validate.js';
import {
  importAccountMediaSchema,
  importUrlSchema,
  instagramPublicImportSchema,
  instagramPublicPreviewSchema,
  listAccountMediaQuerySchema,
...
router.get(
  '/accounts/:socialAccountId/media',
  validateQuery(listAccountMediaQuerySchema),
  getAccountMedia,
);
router.post(
  '/accounts/:socialAccountId/import',
  validateBody(importAccountMediaSchema),
  importAccountMedia,
);
...
router.post(
  '/instagram/preview',
  instagramPublicLimiter,
  validateBody(instagramPublicPreviewSchema),
  previewInstagramPublic,
);
router.post(
  '/instagram/import',
  instagramPublicLimiter,
  validateBody(instagramPublicImportSchema),
  importInstagramPublic,
);
