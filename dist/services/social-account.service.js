...
export async function connectManualSocialAccount(userId, input) {
    if (input.platform === 'instagram') {
        if (input.accountType !== 'instagram_business' &&
...
export async function deleteSocialAccount(userId, accountId) {
...
export async function testPublishInstagramReel(userId, input) {
