 ...
 */
export async function syncMediaAssetIndexes() {
    try {
        const indexes = await MediaAsset.collection.indexes();
        const legacy = indexes.find((idx) => idx.name === 'userId_1_sourcePlatform_1_sourceExternalId_1' &&
...
//# sourceMappingURL=media-indexes.js.map