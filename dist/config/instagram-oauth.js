...
export function getInstagramAppCredentials() {
    ...
    if (!appId || !appSecret) {
        throw new AppError('Instagram OAuth is not configured. Set INSTAGRAM_APP_ID and INSTAGRAM_APP_SECRET.', 503, 'INSTAGRAM_OAUTH_NOT_CONFIGURED');
    }
...
//# sourceMappingURL=instagram-oauth.js.map