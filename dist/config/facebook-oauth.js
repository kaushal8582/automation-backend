...
export function getFacebookAppCredentials() {
    ...
    if (!appId || !appSecret) {
        throw new AppError('Facebook OAuth is not configured. Set FACEBOOK_APP_ID and FACEBOOK_APP_SECRET (or META_APP_ID/META_APP_SECRET).', 503, 'FACEBOOK_OAUTH_NOT_CONFIGURED');
    }
